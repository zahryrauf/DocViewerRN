...
class MetroBundlerDevServer extends _BundlerDevServer.BundlerDevServer {
   ...
   */ async getStaticRenderFunctionAsync() {
    ...
    async getDevServerRenderOptionsAsync({ location, route, request, resolveMetadata }) {
        ...
        const params = (resolvedLoaderRoute == null ? void 0 : resolvedLoaderRoute.params) ?? {};
        const renderOptions = {
            params
        };
        if (resolveMetadata) {
        ...
        const useServerDataLoaders = ((_exp_extra = exp.extra) == null ? void 0 : (_exp_extra_router = _exp_extra.router) == null ? void 0 : _exp_extra_router.unstable_useServerDataLoaders) === true;
   ...
   */ async getStaticPageAsync(pathname, route, request) {
        ...
        const bundleStaticHtml = async ()=>{
            ...
            return await getStaticContent(location, loader ? {
                loader
            } : undefined);
        };
